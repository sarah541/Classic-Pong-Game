...
def ball_init(right):
    ...
    if right == True:
        ball_pos = [WIDTH / 2, HEIGHT / 2]
        ball_vel = [random.randrange(4, 7), -random.randrange(2, 5)]
    if right == False:
        ball_pos = [WIDTH / 2, HEIGHT / 2]
...
def draw(c):
    ...
    c.draw_text(str(score2), (450, 50), 36, "White")
    c.draw_text(str(score1), (150, 50), 36, "White")
    if score2 == 7:
        c.draw_text("You Win!",(400,100), 36, "Red")
        ball_pos = [WIDTH/2,HEIGHT/2]
        ball_vel = [1,1]
    elif score1 == 7:
        c.draw_text("You Win!",(100,100), 36, "Red")
        ball_pos = [WIDTH/2,HEIGHT/2]
        ball_vel = [1,1]
